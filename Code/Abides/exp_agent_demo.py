...
# MYPART1) ExampleExperimenta Agents

num_MY_agents = 2
agents.extend([ExampleExperimentalAgentTemplate(id=j,
                             name="ExampleExperimentalAgentTemplate{}".format(j),
                             type="ExampleExperimentalAgentTemplate",
                             symbol=symbol,
                             starting_cash=starting_cash,
                             levels=1,
							 ...
							 high=2 ** 32, dtype='uint64')))                                                                                          
               for j in range(agent_count, agent_count + num_MY_agents)])
agent_count += num_MY_agents
agent_types.extend("ExampleExperimentalAgentTemplate")

# MYPART2) ExampleExperimenta Agents

num_MY_agents2 = 2

agents.extend([ExampleExperimentalAgent(id=j,
                             name="ExampleExperimentalAgent{}".format(j),
               ...
               for j in range(agent_count, agent_count + num_MY_agents2)])
agent_count += num_MY_agents2
agent_types.extend("ExampleExperimentalAgent")
